...
-- Run this in Supabase SQL Editor: https://supabase.com/dashboard/project/xmfiisxvjrbvnufibgve/sql/new
-- Note: After inserting, you should update the image_url fields with the actual imported image paths
-- The images are in: src/assets/event-*.jpg and need to be imported in the admin panel
