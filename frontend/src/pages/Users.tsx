    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#0F172A] relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl relative z-10">
        <div className="text-center mb-16 animate-fadeInUp px-4">
          ...
          <p className="text-gray-300 text-xl">Select a product to access its features</p>
        </div>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center text-center space-y-6">
                  ...
                  <div className="space-y-3">
                    <h2 className="text-3xl font-bold text-white group-hover:gradient-text transition-all duration-300">{type.title}</h2>
                    <p className="text-gray-400 group-hover:text-gray-300 transition-colors text-base">{type.description}</p>
                  </div>
